...
[07:30-08:15]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030001  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END),
[08:15-09:00]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030002  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END),
[09:00-09:45]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030003  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END),
[10:00-10:45]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030004  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END),
[10:45-11:30]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030005  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END),
[11:30-12:15]=
COUNT(CASE
		WHEN SHORARIOTURMA.CODHOR = 1030006  THEN 1
		WHEN SHORARIOTURMA.DATAINICIAL = '11/09/2022' THEN 1 END)
