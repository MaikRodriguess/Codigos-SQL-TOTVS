...
DECLARE @RA INT; 
SET @RA = 059797 --Digite o RA do aluno

select  DC. PLETIVO, HF.NomFilial, HF.NomCurso, HF.NomTipoCurso, NomTurno, PPESSOA.NOME, DC.RA, DC.DISCIPLINA,DC.STATUS, DC.NOTA, DC.FALTAS, HF.NomGrade, HF.CODGRADE,HF.Status, [DISCEQUIV] = 
      CASE
...
-- Tabela das disciplinas equivalentes
